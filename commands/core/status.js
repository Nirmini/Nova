...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('status')
        .setDescription('Get the status of Nova'),
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                'This bot is provided by Nirmini\'s Structural Engineering Team. ' +
                'If you have any questions, comments, or concerns, please contact us via ' +
                '[our website](https://nirmini.dev/Nova) or [support server](https://discord.gg/9Y7aZejzUH).'
            )
            .addFields(
                {
                    name: '**General Stats**',
