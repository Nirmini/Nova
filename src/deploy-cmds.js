// THIS IS DEPRECATED!! USE /minapp/publish-cmds.js INSTEAD!!
...
async function deployCommands() {
    try {
        console.warn("/src/deploy-cmds.js is DEPRECATED and will be removed soon. Please use /mainapp/publish-cmds.js instead.")
